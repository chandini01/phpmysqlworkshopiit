...
<table align="center">
<tr>	<th><label>Roll no. </label></th><td><input type="number" name="roll"></td></tr>
...
$sql = mysqli_query($mysqli,"UPDATE login SET `PHP`='$php',`MySQL`='$mysql',`HTML`='$html',`total`='$sum',`out of`='$out',`percent`='$per',`status`='$status' WHERE `Rollno`='$roll'");
